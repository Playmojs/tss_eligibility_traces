...
def eligibilityNavigationWithLayers(symbols, start, goal, distance, ms_per_frame):
        ...
        while final_time + 15 > current_time: #keeps running until 15 ms after goal is found, or exception
            ...
            for activate_id in event_series[current_time].try_activate:
                ...
                sim_utils.scheduleActivate(event_series, 
                                ...
                                valid_transitions[activate_id].transition_ids, symbols[activate_id].layer + 1)
...
eligibilityNavigationWithLayers(symbols, start, goal, 2, 1)
